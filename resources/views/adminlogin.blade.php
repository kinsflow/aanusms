                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('registerAdmin') }}">
                        ...
                        <!-- <div class="form-group row">
                            <label for="matric_no" class="col-md-4 col-form-label text-md-right">{{ __('MatricNumber') }}</label>
                        ...
                        <!-- <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="number" type="tel" class="form-control @error('number') is-invalid @enderror" name="number" value="{{ old('number') }}" required autocomplete="number">
